...
" vundle part by yonka
set rtp+=~/vimrc/vim/bundle/vundle
call vundle#rc()
...
" vim-scripts repos
" Bundle 'L9' #comment to avoid collision by yonka
" Bundle 'FuzzyFinder' #comment to avoid collision by yonka
" non-GitHub repos
Bundle 'git://git.wincent.com/command-t.git'
" Git repos on your local machine (i.e. when working on your own plugin)
" Bundle 'file:///Users/gmarik/path/to/plugin'
" ...
filetype plugin indent on     " required! nable detection, plugins and indenting in one step
"should not be deleted along with vbundle #by yonka
"
" Brief help
...
set colorcolumn=80	" by yonka, to place a line marker
...
" customized commands by yonka
command MA set mouse=a
command MV set mouse=v
command NM set nomodifiable
command AM set modifiable
